...
if (received_char == 'R') {
UART_ESC_Code();
UART_print("[31m"); // change text color to red
} else if (received_char == 'B') {
UART_ESC_Code();
UART_print("[36m"); // change text color to blue
} else if (received_char == 'G') {
UART_ESC_Code();
UART_print("[32m"); // change text color to green
} else if (received_char == 'W') {
UART_ESC_Code();
UART_print("[37m"); // change text color to white
} else {
